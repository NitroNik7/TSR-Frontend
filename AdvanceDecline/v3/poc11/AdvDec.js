var dyadr = (function () {  // Advance Decline
	...
	*/
    ...
    <!-- 1. Left Accent Identity Deck -->
    <div class="tsrAdrAssetIdentityDeck">
        <div class="tsrAdrAssetMeta">
            <span class="tsrAssetName">${indexObj.label}</span>
        </div>
        
        <!-- 2. Integrated Side-Car Action Tab (Redesigned view trigger) -->
        <div class="tsrAdrRowSideCarTab" onclick="event.stopPropagation(); dyadr.har(this.closest('.tsrAdrRowCard'), 'FuturesAndOptions'); dyadr.ua('chart', 'FuturesAndOptions');">
            <i class="fas fa-chart-area"></i>
            <span class="tsrAdrTabTip">Open Chart</span>
        </div>
    </div>
    ...
    <div class="tsrAdrBreadthCoreGroup">
        ...
        <!-- 4. Stacked Progress Deck with Top Indicators -->
        <div class="tsrAdrBarCentralFlex flex-grow-1">
            <div class="tsrAdrSideRatioLabels d-flex justify-content-between w-100 mb-1 px-1">
                <span class="tsrAdrMetricLabelSub tsrAdrTextGreen">Adv: <strong>90</strong></span>
                <span class="tsrAdrMetricLabelSub tsrAdrTextRed">Dec: <strong>120</strong></span>
            </div>
