var dyadr = (function () {  // Advance Decline
	...
	// var xAxisStyle = "stroke: #e2e8f0; stroke-width: 1px; font-family: Inter, sans-serif; font-size: 11px; color: #64748b;";
	// var yAxisStyle = "stroke: #e2e8f0; stroke-width: 1px; font-family: Inter, sans-serif; font-size: 11px; color: #64748b;";
	...
	function drawChartFromData(data) {
		...
		function mousemove(e) {
			...
			let displayDate = selectedData.Date.toLocaleDateString().replaceAll("_", " ");
