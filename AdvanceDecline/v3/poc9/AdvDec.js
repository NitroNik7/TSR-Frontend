			...
			html += `
				<div class="tsrAdrRowCard" data-index-id="${index.id}" onclick="dyadr.har(this, '${index.id}'); dyadr.ua('chart', '${index.id}');">
					<div class="tsrAdrAssetIdentity">
						...
						<button type="button" class="tsrAdrActionBtn tsrAdrBtnPrimary" onclick="event.stopPropagation(); dyadr.har(this.closest('.tsrAdrRowCard'), 'FuturesAndOptions'); dyadr.ua('chart', 'FuturesAndOptions');">
							<i class="fas fa-chart-line me-1"></i> View Chart
						</button>
					</div>
