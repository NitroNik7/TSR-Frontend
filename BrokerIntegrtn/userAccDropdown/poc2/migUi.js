...
var migUi = (function () {  // my Ui Head
    ...
    function getBrokers() {
        ...
        if (userProf.brokerLogin) { // * user is connected with broker
            html += `<li onclick=""> `;
            html += `   <a href="">`
        ...
        else if(userProf.status === 'signedIn' && !userProf.brokerLogin) { // * user is signed in with TSR, but not connected to any broker
            html += '<li>';
            html += '   <a href="" >';
