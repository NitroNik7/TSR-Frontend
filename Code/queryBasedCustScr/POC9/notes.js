...
// // TODO Capitalize AND | OR
// // TODO In syntax validation - add logic for comparing fields other than price fields

// ? Show advanced options as a floating div, just like suggestionsDiv
...
// //         ! Inconvenient, since user might not know what fields are supported and would be inconvenient for them to type in all fields, that too w/o errors


// // TODO Task 2: Add funda ratios
// // * Completed TODO Task 2a: Inserting metric which has a space in between
...
// ? Task 3: Suggestions div should consist of select/input box
...
// ! Bug #8: On copy pasting query, clicking on keywords doesn't show correct advanced options, most probably because we are not setting operators[]
// ! Bug #9: Typing in a keyword manually, and then adding other keywords using suggestions Div, followed by updating manually typed keyword, results in incorrect update of keyword
...
// * Using DIV instead of a textarea element in HTML, by using contentEditable attribute
// * Challenges
// * Pro's:
    // * Can use different font styles for keywords, operators and advanced options 
    // * Can show tooltip on mouseover 
    // * Can show exactly where we have a syntax error  
// * Con's:
    // * Will have to rewrite updateSuggestionsPosition()
