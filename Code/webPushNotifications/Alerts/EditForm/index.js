...
// function to save updated Alert
function saveAlert(){
  document.getElementById("tsrAlertToast").style.display = "block";
}
// Rewrite validForm()
// function to validate if correct input is entered by user
...
$(".tsr_alert_form_info").hover(
  function (event) {
    ...
    console.log("Hovered", infoChildId, top, left);
  ...
  if (e.target.value == "webAlert") {
    ...
    div.innerHTML = `
            <div class="mt-0" style="height: ${height}; overflow-y: auto; font-size: 18px;">
              ...
              <span style="color:#6e4848; font-size: 16px;">Recommendation: Please enter a short name for SMS Alert. </span>
                <section class="tsr_alert_form_info" style="display: inline !important;">
                    <i class="fas fa-info-circle"></i>
                    <div id="infoChild15" class="tsr_alert_form_info_child">
    ...
    div.innerHTML = `
            <div class="mt-0" style="height: ${height}; overflow-y: auto; font-size: 18px;">
                ...
                <span style="color:#6e4848; font-size: 16px;">Recommendation:  Please enter a short name for Whatsapp Alert. </span>
                <section class="tsr_alert_form_info" style="display: inline !important;">
                    <i class="fas fa-info-circle"></i>
                    <div id="infoChild16" class="tsr_alert_form_info_child">
