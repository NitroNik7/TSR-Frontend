var miIs = (function () {  // chart init Params
    ...
    function init(mobile, type) {
        ...
        if (mobile) {
            ...
            searchForm += `     <div class="miSearchWrapper d-flex w-100" style="box-sizing: border-box;">`
            ...
            if (!jsu.isMigContext()) {
                ...
                searchForm += `
                                    <div class="d-flex flex-column justify-content-evenly text-center w-100 mx-3">
