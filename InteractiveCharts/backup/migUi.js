 ...
 * * sideNavInit() - adds interactivity to nav menu using event listeners and onClicks for either mobile or desktop
 * if(page != interactiveCharts)
 ...
 * both of the above () - printHeader(), sideNavInit() are called again if window is resized / device orientation is changed
 * 
 ...
 * when sideNavInit() is called for the first time by migUi.init() - event listeners are attached to nav menu(present in html)
