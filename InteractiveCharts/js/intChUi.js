    ...
    function getChartPanel() {
        ...
        html += `
                    <div id='chartPanel' class="chartPanel">
                        ...
                        <div id="chartFocus" style="margin:1px ; padding:1px; height:1px;width:1px"
                            tabindex='1'>
                        </div>
                        ...
                        <div id='selectedValues' align='center'
                            style='padding:0px;margin:3px; font-size: 8pt;height:12px; white-space:nowrap '>
                        </div>
        ...
        if (!isLayoutLoaded) {
            ...
            if (window.innerWidth > 992) {
                ...
                splitLayout.cl(chContainer, chPanelWrapperId, "horizontal", 2);

                const grandChild = chContainer.children(".column").last();
                splitLayout.cl(grandChild, chPanelWrapperId + "Child", "vertical", 2);

                let chPanel = document.getElementById(chPanelWrapperId + "Column1");
