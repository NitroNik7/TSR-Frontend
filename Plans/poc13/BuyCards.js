...
var miSupc = (function () { // Mi Subscription plan cards ...
    ...
    let CSS_OLD_PRICE = `text-decoration: line-through; color: #adb5bd; font-size: 22px; text-wrap: nowrap; font-weight: 600; font-weight: 600; text-decoration-thickness: 3px; text-decoration-color: #a8a8a8;`
    ...
    let CSS_EFF_PRICE = `font-size: 14px; color: #6c757d; margin-bottom: 16px;`
    ...
    function getCard(details, period) {
        ...
        if (jsu.isNotNull(planData.off)) { // TODO planData price per day
            html += ` <div  style="${CSS_EFF_PRICE};display: block;">Effective 
                <strong><i class="fas fa-rupee-sign"></i> ${Math.round(planData.perMth / 30)}/day</strong></div>`
        }
