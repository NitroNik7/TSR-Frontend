var miChTb = (function () {
    ...
    function getToolsContainer() {
        ...
        html += `   <button id="tsrChReplayPeriod" class="btn btn-sm dropdown-toggle" type="button" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-expanded="false">`
        html += `       From Chart`
        html += `   </button>`
        html += `   <ul class="dropdown-menu">`
        html += `       <li>`
        html += `           <button class="btn btn-sm" onclick="miChTb.urp('chart')">From Chart</button>`
        html += `       </li>`
        html += `       <li>`
