...
function ch_openSaveSettingsPopup() {
    ...
    <ul>
        ...
        <li role="separator" class="divider"></li>
        <div popovertarget="ch_settingsOption">
...
function ch_getSavedSettings() {
    ...
    for (let i = 0; i < notes.length && i < 3; i++) {
        html += `<li class="ch_savedSettingsListItem" onclick="ch_editSavedSetting(${i})">
...
function ch_editSavedSetting(index) {
    removeDialogOnEscPress();
