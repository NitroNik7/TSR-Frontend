...
//                      OR
// Facebook - https://www.facebook.com/sharer/sharer.php?u=example.org
...
function closeSaveSettingsDropdown(e) {
    if (ch_savePopupWrapper.style.display === "block" && !(ch_savePopupWrapper.contains(e.target) || document.getElementById("openSaveSettingsDropdown").contains(e.target))) {
        // ch_savePopupWrapper.innerHTML = "";
        ch_savePopupWrapper.style.display = "none";
        let dropdownBtn = document.getElementById("openSaveSettingsDropdown");
...
function ch_openSaveSettingsPopup(openDropdown) {
    let dropdownBtn = document.getElementById("openSaveSettingsDropdown");
    if (dropdownBtn.style.rotate == "0deg" || dropdownBtn.style.rotate == "")
        dropdownBtn.style.rotate = "-180deg";
    else
    ...
    if (openDropdown) {
        ...
        if (ch_savePopupWrapper.style.display === "block") {
            ch_saveSettingsOption("save", false);
        }
...
function ch_getSavedSettings() {
    ...
    for (let i = 0; i < notes.length && i < 3; i++) {
        if (settingsApplied[i] === 1) {
            html += `<li class="ch_savedSettingsListItem" onclick="ch_applySettingsToChart(${i})">
            <div class="ch_settingApplied" style="display: block;"><i class="fa-solid fa-check"></i></div>
            <span>${notes[i].title}</span>
            <button class="ch_updateSavedSettingsBtn" onclick="ch_editSavedSetting(event, ${i}, false)" popovertarget="ch_settingsOption"><i class="fa-solid fa-pen-to-square"></i></button>
        </li>`;
        } else {
            html += `<li class="ch_savedSettingsListItem" onclick="ch_applySettingsToChart(${i})">
            <div class="ch_settingApplied"><i class="fa-solid fa-check"></i></div>
            <span>${notes[i].title}</span>
            <button class="ch_updateSavedSettingsBtn" onclick="ch_editSavedSetting(event, ${i}, false)" popovertarget="ch_settingsOption"><i class="fa-solid fa-pen-to-square"></i></button>
        </li>`;
        }
...
const ch_shareSettings = `
    <div class="ch_shareSettings">
        <div>
            <input type="radio" name="ch_share" id="facebook" value="https://www.facebook.com/sharer/sharer.php?u=example.org">
            <label for="share"><i class="fa-brands fa-facebook-f" style="color: #0866ff;"></i></label>
        </div>
        <div>
            <input type="radio" name="ch_share" id="xTwitter" value="xTwitter">
        ...
        <div>
            <input type="radio" name="ch_share" id="linkedIn" value="linkedIn">
...
function ch_showCollapseAccordionDiv() {
    var acc = document.getElementsByClassName("ch_accordionSection");
    var i;
    ...
    for (i = 0; i < acc.length; i++) {
        acc[i].addEventListener("click", function () {
            ...
            var panels = document.getElementsByClassName("ch_accordionPanel");
    ...
    switch (str) {
        case "save":
            ch_settingsOptionDiv.innerHTML = `
                <div class="ch_settingsOptionHeader">
                    <p style="margin: 0">Save</p>
                    ${ch_closeSettingsOption}
                </div>
                <div id="ch_toastContainer">
                </div>
                <div id="ch_settingsOptionContent" class="ch_settingsOptionContent">
                    <div class="ch_accordion">
                        <button class="ch_accordionSection active">
                            <i class="fa-solid fa-plus"></i>
                            <span>Create new</span>
                            </button>    
                        </button>
                        <div class="ch_accordionPanel">
                            
                            <input type="text" name="settingsName" id="settingsName" class="ch_optionInput" placeholder="" autocomplete="off">
                    ...
                    <div class="ch_accordion">
                        <button class="ch_accordionSection">
            ...
            ch_settingsOptionDiv.innerHTML = `
                ...
                <div class="ch_accordion">
                    ...
                    <div class="ch_accordionPanel">
                        ...
                        <input type="text" name="ch_imageName" id="ch_imageName" class="ch_optionInput" placeholder="" autocomplete="off">
                ...
                <div class="ch_accordion">
                    ...
                    <div class="ch_accordionPanel">
                        <input type="text" name="ch_serverImageName" id="ch_saveImageName" class="ch_optionInput" placeholder="" autocomplete="off">
            ...
            ch_settingsOptionDiv.innerHTML = ` 
                ...
                <div id="ch_settingsOptionContent" class="ch_settingsOptionContent">
                    <form action="" target="_blank">
                        ${ch_shareSettings}
                        <hr>
                        <div class="ch_accordionPanel" style="text-align: center; display: block;">
                            <input type="text" name="ch_shareMessage" id="ch_shareMessage" class="ch_optionInput" placeholder="" autocomplete="off">
...
function ch_showToast(message, action) {
    ...
    toast.className = 'ch_toastNotification';
    ...
    if (action == "save") {
        ...
        toast.innerHTML = `
            <span>
                ${message}            
                <span class="ch_toastAction" onclick="ch_saveSettingsOption('download', true)">Download</span>
            </span>
    ...
    `;
        ...
        toast.innerHTML = `
            <span>
                ${message}
                <span class="ch_toastAction" onclick="ch_saveSettingsOption('manage settings', true)">Manage all settings</span>
            </span>
    ...
    `;
        ...
        toast.innerHTML = `
            <span>
                ${message}
                <span class="ch_toastAction" onclick="ch_saveSettingsOption('share', true)">Share</span>
            </span>
...
function ch_editSavedSetting(e, index, remove) {
    ...
    ch_settingsOptionDiv.innerHTML = `
                ...
                <div id="ch_settingsOptionContent" class="ch_settingsOptionContent">
                    <div class="ch_accordionPanel" style="display: block;">
                        <input type="text" name="ch_editSettingsName" id="ch_editSettingsName" class="ch_optionInput" placeholder="" autocomplete="off" value="${notes[index].title}">
