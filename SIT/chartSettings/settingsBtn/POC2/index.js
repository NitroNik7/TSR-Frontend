    ...
    switch (option) {
        ...
        <div id="ch_sttg_VolumeSettings" class="ch_sttg_VolumeSettings">
            ...
            <div class="ch_sttg_volumeRadioButtons">
                <div class="ch_sttg_volRadioButton" >
                    <input type="radio" name="volRadioButton" id="" onclick="showVolBarSettings()" checked>
                    <label for="volRadioButton">Bar</label>
                </div>
                <div class="ch_sttg_volRadioButton">
                    <input type="radio" name="volRadioButton" id=""  onclick="showVolLineSettings()">
                    <label for="volRadioButton">Line</label>
                </div>  
                <div class="ch_sttg_volRadioButton" >
                    <input type="radio" name="volRadioButton" id="" onclick="showVolBarAndLineSettings()">
...
function getSaveResetButtonChartTypeHTML(chartType) {
    let html = `
        <div class="lineChartSettingRow" id="saveResetChartTypeButtonWrapper" style="position: absolute; bottom: 10px;">
...
function showVolBarAndLineSettings() {
    ...
    volBarAndLineSettingsDiv.innerHTML = `
        <div class="lineChartSettingRow">
            <span style="font-size: 14px; font-weight: 300;">Bar</span>
        </div>
        <div class="lineChartSettingRow">
                <span>Up color</span>
                ${colorPickerHtml}
