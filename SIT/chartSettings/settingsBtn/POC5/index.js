...
function saveChartTypeAsDefault(type, label) {
    let html = `
        <div class="ch_sttg_saveChartTypeAsDefaultWrapper" >
            <input type="checkbox" name="saveChartTypeAsDefaultFor${type}" class="ch_sttg_checkbox" id="saveChartTypeAsDefaultFor${type}" onchange="saveChartTypeAsDefaultFor${type}()">
            <label for="saveChartTypeAsDefaultFor${type}" style="cursor: pointer;">&thinsp; ${label}</label>
        </div>
    `;
    return html;
};
...
function ch_settingsOption(e, option) {
    ...
    switch (option) {
        case "chart type":
            ...
            <div id="chartTypeSettingsContainer" style="padding: 10px; background-color: white; max-height: 430px; overflow-y: auto; scroll-behavior: smooth;">
            <div class="" style="margin-bottom: 5px; margin-left: 5px;">
                <span style="">Set Chart Type as default</span>
            ...
            <div class="ch_sttg_chartTypeTopSection" style="display: flex; justify-content: space-between; align-items: center;">
                ...
                <div class="">
                <input type="checkbox" class="ch_sttg_checkbox">
                <span style="font-size: 14px; font-weight: 300;">Set Default for Screener Charts</span>
                </div>
            </div>
...
let haSettingsHtml = `
    <div class="ch_sp_chartSettingRow">
                ...
                ${saveChartTypeAsDefault("HeikinAshi", "Same as Candle")}
            </div>
        <div class="candleChartOptions">
...
let hollowCandleSettingsHtml = `
    <div class="ch_sp_chartSettingRow">
                ...
                ${saveChartTypeAsDefault("HollowCandle", "Same as Candle")}
            </div>
...
function plotVolumeMA(plotVolumeMACheckbox) {
    ...
    if (plotVolumeMACheckbox.checked) {
        ...
        document.getElementById("ch_sttg_volumeSettingsContainer").scrollTo({"top": volMaLineSettingsDiv.getBoundingClientRect().top});
    } else {
...
function ch_showCollapseAccordionDiv() {
    ...
    var i;
    let chartTypeSettingsContainer = document.getElementById("chartTypeSettingsContainer");
            ...
            if (this.id == "lineSettingsBtn") {
                ...
                for (let i = 0; i < panels.length; i++) {
                    if (panels[i].id == "lineSettingsPanel") {
                        ...
                        chartTypeSettingsContainer.scrollTop = panels[i].getBoundingClientRect().top;
                    } else {
                        panels[i].innerHTML = ``;
