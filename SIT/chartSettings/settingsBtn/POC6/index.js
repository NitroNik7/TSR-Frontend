            ...
            <div id="ch_sttg_chartTypeSettingsContainer" style="padding: 10px; background-color: white; max-height: 430px; overflow-y: auto; scroll-behavior: smooth;">
                ...
                <div class="ch_sttg_chartTypeTopSection" style="display: flex; justify-content: space-between; align-items: center;">
                    ...
                    <span>
                        ...
                        <ul id="chartTypechooseOptionList" style="top: 197.05px; display: none;">
                            <li onclick="chartTypeSetting('Line')">
                                <span>Line</span>
                            </li><li onclick="chartTypeSetting('Candle')">
                                <span>Candle</span>
                            </li><li onclick="chartTypeSetting('OHLC')">
                                <span>OHLC</span>
                            </li><li onclick="chartTypeSetting('Hollow Candles')">
                                <span>Hollow Candles</span>
                            </li><li onclick="chartTypeSetting('Heikin Ashi')">
                                <span>Heikin Ashi</span>
                            </li><li onclick="chartTypeSetting('Area')">
                                <span>Area</span>
                            </li>
                        </ul>
                    </div>
...
let axesSettingsHtml = `
    ...
    <div>
        ...
        <div class="chartTypeSttgContainer">
            ...
            <div class="ch_sp_chartSettingRow">
                <div id="chooseLineThicknessWrapper" class="choose_chart_type_option_wrapper">
                    <div id="lineThicknessSelector" class="chart_type_option_selector" onclick="showLineThicknessOptions(this, 'lineThicknessOptionListforAxis')">
                        <span><svg height="20" width="40" background-color="white">  <line x1="0" y1="10" x2="250" y2="10" style="stroke:black;stroke-width:0.7"></line> </svg></span>
                        <span>
                            <i class="fas fa-caret-down"></i>
                        </span>
...
let xAxisSettingsHtml = `
    ...
    <div id="chooseDateWrapper" class="choose_chart_type_option_wrapper">
        <div id="dateFormatSelector" class="chart_type_option_selector" onclick="showDateFormatOptions(this, 'DateFormatListforXAxis')">
    ...
    if (checkbox.id == "ch_sttg_yAxisLeftSettingsCheckbox") {
        ...
        if (checkbox.checked) {
            ...
            div.innerHTML = `
                ...
                <div class="choose_chart_type_option_wrapper">
