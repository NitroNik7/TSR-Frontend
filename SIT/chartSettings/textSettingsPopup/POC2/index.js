    ...
    div.innerHTML = `
        ...
        <div class="ch_settings_panel" >
            <div class="chCusSetRow" style=" margin: 0px">
                <span style="font-size: 14px; font-weight: 300;">Enter Text</span>
            </div>
                <input id="" type="text">
            </div>
        ...
        <div class="chartTypeSttgContainer">
            ...
            <div class="chCusSetRow" style="align-items: anchor-center; margin-bottom: 10px;">
                <div>
                    <input type="checkbox" name="ch_text_background" class="ch_sttg_checkbox"
                        id="chTextBackground" onchange="">
                    <label for="chTextBackground" style="font-size: 14px; font-weight: 300; margin-right: 5px;">Background</label>
                </div>
                <div class="chCusSetRow">
                ${colorPickerHtml}
                </div>
            ...
            <div class="chCusSetRow">
                <span style="font-size: 14px; font-weight: 300;">Rotate</span>
                <select name="chTextRotateOptions" id="chTextRotateOptions">
                    <option value="Horizontal">Horizontal</option>
                    <option value="Vertical">Vertical</option>
                    <option value="Tilted up">Tilted up</option>
                    <option value="Tilted down">Tilted down</option>
                </select>
            </div>
