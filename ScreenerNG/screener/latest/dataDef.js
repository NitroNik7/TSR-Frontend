...
// ==============================================
    ...
    var PRICE_ACTION_DEF = [
        { id: "price", label: "Price", title: "Price", func: "csp.pfr", params: ["csPrice"], subMenu: null, addOnce: true, premium: false, url: baseUrl + "/help/custScr/priceAction/data.html" },
        ...
        { id: "turnover", label: "Turnover", title: "Add Turnover", func: "csp.pfr", params: ["turnOver"], subMenu: null, addOnce: false, premium: false },
        { id: "vwap", label: "A / MA / PP - VWAP", title: "Add A / MA / PP - VWAP", func: "csp.pfr", params: [CS_VWAP], subMenu: null, addOnce: false, premium: true },
        { id: "breakOutBreakDown", label: "Break Out / Down", title: "Add Break Out / Down", func: "csp.pfr", params: ['priceBoBd'], subMenu: null, addOnce: false, premium: true },
        { id: "ohlcTimeCompare", label: "OHLC Specific Time Compare", title: "Add OHLC Specific Time Compare", func: "csp.pfr", params: ["dynSpTimepriceComp", "priceCs"], subMenu: null, addOnce: false, premium: true },
        { id: "ohlcvAdvanced", label: "OHLCV Advanced", title: "Add OHLCV Advanced", func: "csp.pfr", params: ["dynAdvOhlcComp"], subMenu: null, addOnce: false, premium: true },
        { id: "demandSupplyZones", label: "Demand & Supply Zones", title: "Demand & Supply Zones", func: "csp.pfr", params: ["rbr", "rallyBaseCom"], subMenu: null, addOnce: false, premium: true },
        { id: "trendingCandleBoDwn", label: "Trending Candles", title: "Trending Candles", func: "csp.pfr", params: [TREND_CANDLE_BOBD], subMenu: null, addOnce: false, premium: true },
        ...
        { id: PREV_RANGE_BOBD, label: "Previous Range Strategies", title: "Add Previous Range Strategies", func: "csp.pfr", params: [PREV_RANGE_BOBD], subMenu: null, addOnce: false, premium: true },
    ...
    var VOL_DEF = [
        { id: "tickVol", label: "Tick Volume", title: "Tick Volume", func: "csv.pfr", params: ["csVol", 220], subMenu: null, addOnce: true, premium: false },
        { id: "dayVol", label: "Days Volume", title: "Days Volume", func: "csv.pfr", params: ["csDayVol", 220], subMenu: null, addOnce: true, premium: false },
        { id: "compPrevTick", label: "Compare With Prev Ticks", title: "Compare With Prev Ticks", func: "csv.pfr", params: ["ac"], subMenu: null, addOnce: false, premium: false },
        { id: "volTrend", label: "Volume Trending", title: "Add Volume Trending", func: "csv.pfr", params: ["atn"], subMenu: null, addOnce: false, premium: false },
        { id: "tickVolVsHistAvg", label: "Tick Vol Vs. Hist Avg", title: "Tick Vol Vs. Hist Avg", func: "csv.pfr", params: ["athv"], subMenu: null, addOnce: false, premium: false }
    ]
    ...
    var PIVOT_DEF = [
        { id: "pricePivotLevel", label: "Price / Pivot Levels", title: "Add Price / Pivot Levels", func: "cspp.pfr", params: ["pp"], subMenu: null, addOnce: false, premium: false },
        { id: "centralPivotLevel", label: "Central Pivot Levels", title: "Add Central Pivot Levels", func: "cspp.pfr", params: ["cpr"], subMenu: null, addOnce: false, premium: false },
        { id: "FibRetracement", label: "Fibonacci Retracement", title: "Add Fibonacci Retracement", func: "cspp.pfr", params: ["fibr"], subMenu: null, addOnce: false, premium: true },
    ]
   ...
   var STRENGTH_DEF = [
    ...
    var MA_DEF = [
        { id: "pma", label: "Compare Price & MA", title: "Add Compare Price & MA", func: "csma.pfr", params: ["pma"], subMenu: null, addOnce: false, premium: false },
        ...
        { id: "maDiv", label: "MA Divergence", title: "Add MA Divergence", func: "csma.pfr", params: ["maDiv"], subMenu: null, addOnce: false, premium: true },
    ];
    ...
    var GURU_LIST = [];
    addToRatioList(GURU_LIST, GURU_NUMBERS, GURU_LIST_CODE, "csFrNg.pfr");

    var VAL_RATIO_LIST = [];
    addToRatioList(VAL_RATIO_LIST, RATIO_VAL_DEF, VAL_RATIO_LIST_CODE, "csFrNg.pfr");

    var PFT_RATIO_LIST = [];
    addToRatioList(PFT_RATIO_LIST, RATIO_PFT_DEF, PFT_RATIO_LIST_CODE, "csFrNg.pfr");

    var SOL_RATIO_LIST = [];
    addToRatioList(SOL_RATIO_LIST, RATIO_SOL_DEF, SOL_RATIO_LIST_CODE, "csFrNg.pfr");

    var EFF_RATIO_LIST = [];
    addToRatioList(EFF_RATIO_LIST, RATIO_EFF_DEF, EFF_RATIO_LIST_CODE, "csFrNg.pfr");
    ...
    var BS_LIST = [];
    addStmtToList(BS_LIST, BAL_SHEET_ALL, BS_LIST_CODE, "csStmtNg.pfr");

    var CF_LIST = [];
    addStmtToList(CF_LIST, CASH_FLOW_ALL, CF_LIST_CODE, "csStmtNg.pfr");


    var ISY_LIST = [];
    addStmtToList(ISY_LIST, INC_STMT_ALL, ISY_LIST_CODE, "csStmtNg.pfr");

    var ISQ_LIST = [];
    addStmtToList(ISQ_LIST, INC_STMT_ALL, ISQ_LIST_CODE, "csStmtNg.pfr");
    ...
    function getTabs(){
        ...
        if(!mtgv.cs.ng || inMyTsr){
            return daily_tabs;
        }

            let userTab = localStorage.getItem( "csusrtabs" ); 

            if(userTab == null || userTab == CS_USR_TAB_PRO){
               return daily_tabs;
            }else{

                let tabOrder = [];

                if(userTab == CS_USR_TAB_TRADER){
                    tabOrder = [PRICE_CS, VOL_CS, PP_CS ,STR_CS, MA_CS , TI_CS, DIV_CS, CP_CS, HL_CS , BV_CS,  ];   // FIN_RAT_NG , FIN_STMT_NG, HL_CS , BV_CS,  FIN_RAT_NG , FIN_STM_NG
                }else if(userTab == CS_USR_TAB_INV){
                     tabOrder = [PRICE_CS, FIN_RAT_NG , FIN_STMT_NG ,STR_CS, HL_CS , BV_CS, VOL_CS, MA_CS ,];  //  TI_CS, DIV_CS, CP_CS, PP_CS
                }else if(userTab == CS_USR_TAB_BEGIN){
                    tabOrder = [PRICE_CS , HL_CS, STR_CS, FIN_RAT_NG, CP_CS,  VOL_CS, MA_CS  ,FIN_STMT_NG];
                }
                ...
                for(let i=0;i<tabOrder.length;i++){
                    ...
                    let tab = jsu.getObjFrmArr(daily_tabs, tabOrder[i] );
    ...
    function enrich(){
        ...
        // if(tabs == null ) tabs = daily_tabs// Fall back 
