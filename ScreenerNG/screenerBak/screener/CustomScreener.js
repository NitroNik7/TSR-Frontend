...
var myTsrScreener = (function () {
	...
	// modified - hardcoded values -- to be removed -- search for 'todo remove'
	function init() {

		mtgv.mtpp.analCat.push("tech"); // todo remove
		mtgv.mtpp.crossFreq = true; // todo remove
		mtgv.mtpp.DIV_TYPE=[{id:"bul",label:"Bullish",bul:!0},{id:"bulMld",label:"Mild Bull",bul:!0},{id:"bulWk",label:"Weak Bull",bul:!0},{id:"bulHid",label:"Bull Hidden",bul:!0},{id:"bulPot",label:"Potential Bullish",bul:!0},{id:"br",label:"Bearish",bul:!1},{id:"brMld",label:"Mild Bear",bul:!1},{id:"brWk",label:"Weak Bear",bul:!1},{id:"brHid",label:"Bear Hidden",bul:!1},{id:"brPot",label:"Potential Bearish",bul:!0}] // todo remove - used for divergence.js
	...
	function showControl(id) {
		...
		if (containsString([PRICE_CS], id, true)) {   // containsString()
			...
			html = csStmtNg.ght(id);


		} else if (id == FIN_BASIC) {
			html = csf.basicHtm(id);
		} else if (id == FIN_RATIO) {
			html = csf.finRatio(id);
