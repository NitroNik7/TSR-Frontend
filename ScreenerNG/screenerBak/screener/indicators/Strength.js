...
var csstr = (function () {
	...
	*********************************************/
	...
	function getCustScrFilter(filer) {
		...
		filer.push({
			id: "techStrComp", label: 'Technical Strength', tab: STR_CS,
			type: 'btn', filtDef: { obj: thisObject, fnc: 'addStr', params: 'techStrComp' }, subDef: LIST_TEC_STR
		});  //   JavaScript:cscmn.atn('price','priceCs');


		filer.push({
			id: "techRankComp", label: 'Technical Rank', tab: STR_CS,
			type: 'btn', filtDef: { obj: thisObject, fnc: 'addStr', params: 'techStrComp' }
		});  //   JavaScript:cscmn.atn('price','priceCs');


		filer.push({
			id: "returnsComp", label: 'Stock Returns', tab: STR_CS,
		...
		if (jsu.isMigContext()) {
			...
			filer.push({
				id: "relPriceStrComp", label: 'Relative Price Strength', tab: STR_CS,
