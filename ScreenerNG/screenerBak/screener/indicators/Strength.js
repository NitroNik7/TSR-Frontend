...
// ----------- 
	...
	function getTecStrHtml(techStrobj){
		...
		if(mtgv.cs.ng){
			...
			return  '<tr id='+techStrobj.id+'>'
			 + createTd(createDiv(techStrobj.id+'Td2Div', htmlU.doBold("Technical Strength : ") +  tds.td2, null)) +'</tr>';
		}
	...
	*********************************************/
	...
	function getTecRankHtml(techRankobj){
		...
		if(mtgv.cs.ng){
			'<tr id='+techRankobj.id+'>'
			 + createTd(createDiv(techRankobj.id+'Td2Div',  htmlU.doBold('Tech Rank  : ') + tds.td2, null)) +'</tr>';
			 return;
		}
...
*********************************************/
	...
	function getFundaStrRow(strobj, label){
		...
		if(mtgv.cs.ng){
			'<tr id='+strobj.id+'>'
			 + createTd(createDiv(strobj.id+'Td2Div',  htmlU.doBold('Strength : ') + tds.td2, null)) +'</tr>';
			 return;
		}
	...
	function getFundaRankRow(strobj, label){
		...
		if(mtgv.cs.ng){
			'<tr id='+strobj.id+'>'
			 + createTd(createDiv(strobj.id+'Td2Div',  htmlU.doBold('Rank  : ') + tds.td2, null)) +'</tr>';
			 return;
		}
	...
	*********************************************/
	...
	function getReturnsHtml(returnsobj){
		...
		if(mtgv.cs.ng){
			'<tr id='+returnsobj.id+'>'
			 + createTd(createDiv(returnsobj.id+'Td2Div',  htmlU.doBold('Stock Returns  : ') + tds.td2, null)) +'</tr>';
			 return;
		}
...
/********************************************
	...
	*********************************************/
	...
	function getRelPriceStrHtml(rpsobj){
		...
		if(mtgv.cs.ng){
			'<tr id='+rpsobj.id+'>'
			 + createTd(createDiv(rpsobj.id+'Td2Div',  htmlU.doBold('Relative Price Strength  : ') + tds.td2, null)) +'</tr>';
			 return;
		}
