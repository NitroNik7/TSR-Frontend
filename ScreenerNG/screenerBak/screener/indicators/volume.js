...
function addNewFilter(type){
		...
		if(type=='csVol'){ // Tick Vol 
			...
			id =  myTsrScreener.getNextId('tickHistVolId')
	        ...
	        html = getTickHistVolHtml(tickHistVol);
	...
	// function getDayVolRow(){

	// 	retur
	// 	// return '<tr id="csDayVol">' +createTd(createDiv( 'csDayVol' , td ))  + '</tr>';
	// }
