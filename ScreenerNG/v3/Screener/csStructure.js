...
var csfstr = (function () {  //CS Filter Struc
	...
	*/
	...
	function addResizerListenersNg() {

		if (isMobile()) return;

		resizer.on("mousedown", function (e) {
			e.preventDefault()
			mouseDownHandlerNg(e);
		});
	}


	const mouseDownHandlerNg = function mouseDownHandlerNg(e) {
		...
		if (jsu.isNotNull(colAfter) && jsu.isNotNull(colBefore)) {
			$(document.body).on("mousemove", (e) => {
				colMouseMoveHandlerNg(e, colAfter, colBefore);
			});
			$(document.body).on("mouseup", mouseUpHandlerNg);
		}
	}

	const colMouseMoveHandlerNg = function (e, colAfter, colBefore) {
