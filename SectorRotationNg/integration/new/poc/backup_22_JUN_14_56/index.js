...
var miSrn = (function () {  // chart init Params
    ...
    var stockHlPopupContentId = "tsrSecRotStockSectionPopupContent";
    ...
    function paintStockTableSection(sector, secType, stockType, secId) {
        ...
        if (stockList.length == 0) {
            ...
            for (let i = 0; i < stockList.length; i++) {
                ...
                html += `   <td>`
                html += `               <button class="btn btn-sm btn-outline-primary"`
                html += `                   style="font-size: 12px;" onclick="${onclickFn}" data-bs-toggle="modal" data-bs-target="#${stockHlPopupId}">`
                html += `                   View</button>`
            ...
            if (!(isSectorLoaded(currSectorData, secType, secId))) {
                miSrnUtils.gd(url).then(data => {
                    ...
                    if (data.statusCode == "success") {
                        ...
                        // params.stock
                        miStkHl.pss(params, false, stockHlPopupContentId, true);
