...
var migUi = (function () {  // my Ui Head
        ...
        */
        ...
        if (href.indexOf('/StockTechnicalCharts') > 0 || href.indexOf('/InteractiveCharts') > 0) {
            ...
            if (width < 576) {
                ...
                html += '<div style="text-align:right; width: max-content;" class="myTsrLinksBtn d-flex flex-column justify-content-end h-100 float-end">';
                html += `   <div>`
                html += getAioText(width);
                html += `   </div>`
    ...
    function getUserHead() {
        ...
        html += '						   <a href="" id="upsa" data-bs-toggle="dropdown" style="margin-right:5px">'
        // html +='						   <i class="fas fa-user fa-2x "></i>'
        html += '<span class="fas fa-user fa" style="font-size:20px;"></span>'
