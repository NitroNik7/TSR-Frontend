...
var migUi = (function () {  // my Ui Head
    ...
    function printHeader() {
        // Prints top navbar 
        //      with search box & fotd in desktop 
        //              OR
        //      with searchbox(outside top navbar) in mobile
        ...
        // } else {/home/stagmgr/development/Frontend/navMenu/v2/
        ...
        if (href.indexOf('/StockTechnicalCharts') > 0 || href.indexOf('/InteractiveCharts') > 0) {
            ...
            if (width < 576) {
                ...
                html += '   <div style="display: flex; float:left; align-items: center">' +
                ...
                if (width < 300) {
                    ...
                    if (jsu.isMigContext()) {
                        let homeUrl = jsu.getRootUrl() + '/Home';

                        // logo = '<img src="' + jsu.getStaticUrl() + '/v21/img/tsr/TsrLogo.png" alt="TSR - TopStockresearch"  name="TSR - TopStockresearch" height="45px;" style="vertical-align:top">';
                        // logo = '<img src="' + jsu.getStaticUrl() + '/img/StockAioLogo.png" alt="Stock AIO"  name="Stock All In One" height="45px;" style="vertical-align:top">';
                        html += `   <a href="${homeUrl}" class="p-2">`
                        html += '        <img src="https://www.aiostag.com/static/mig/img/Logo-sm.png" alt="Stock AIO"  name="Stock All In One" height="50px;" style="vertical-align:top">';
                        html += `   </a>`
                ...
                html += '           <div class="col-sm-8 col-md-9 col-lg-9 px-0">'
                    // +  miSrch. gs(showSubcat)
                    + miIs.init()
                    + '             </div>'
                    + '             <div class="col-sm-4 col-md-3 col-lg-3 ps-0">'
    ...
    function getAioText(width) {
        ...
        */
        ...
        // AIO
        //  ===================================================
        //  FLAG | PlANS | MY SETTINGS | USER PROFILE                                                   |
        //  ===================================================
        // TSR
        //  ===================================================
        //  PlANS | MY SETTINGS | USER PROFILE                                                   |
        //  ===================================================

        // ---------------------------- AIO HTML ---------------------
        html += flag();
        if (jsu.isMigContext()) {
            html += `   <div class="d-none d-xl-block vr" style="width: 1px; opacity: 1; background-color: lightgray; margin: 0 10px;"></div>`
        }
        // -----------------------------------------------------------
        ...
        html += `           <div class="${(jsu.isMigContext() ? "mx-2" : "mx-3")} mx-md-0" style="display: flex; align-items: center; text-align: center; cursor: pointer;" onclick="${objName}.help();">`
    ...
    function flag() {
        ...
        html += '						   <a href=""  id="upsa1" class="dropdown-toggle" data-bs-toggle="dropdown">'
    ...
    function getUserHead() {
        ...
        html += '						   <a id="upsa" class="dropdown-toggle" data-bs-toggle="dropdown" style="margin-right:10px">'
        // html +='						   <i class="fas fa-user fa-2x "></i>'
    ...
    function getSignedIn(tsrLogin) {
        ...
        var html = '';
        var hello = jsu.isMigContext() ? "Hello" : "Namaste/Hello";

        if (jsu.isMigContext()) {
            var html = '';

            html += '						      <li>'
            html += '						         <div style="margin: 20px"> <b>' + hello + ',<br> ' + userProf.sal + ' ' + userProf.fName + '</b><br>                                    </div>'
            html += '						      </li>'
            ...
            html += '						         <div style="margin: 20px"> <b>' + hello + ',<br> ' + sal + ' ' + userProf.fName + '</b><br>                                    </div>'
            html += '						      </li>'
            html += '						      <li role="separator" class="divider"></li>'
    ...
    function getPlan() {
        ...
        if (jsu.isRtContext() || jsu.isMyContext()) {
            ...
            var planLink = jsu.getRootUrl() + '/SubscriptionPlans'; // todo
