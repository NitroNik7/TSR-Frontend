var miSrnUtils = (function () {
    ...
    function getColoredValue(val) {
        ...
        if (paramDefined(val)) {
            if (val > 0) {
                ...
                html += "<div style='color: #ff6000;'>" + val + "</div>";
    ...
    function showLoginToast(show) {
        ...
        if (paramDefined(mtgv) && paramDefined(mtgv.mtpp) && paramDefined(mtgv.mtpp) && mtgv.mtpp.pr) {
        ...
        // const myToast = new bootstrap.Toast(toastContainer, {
        //     autohide: true, // Optional: set to false to disable auto-hiding
        //     delay: 5000 // Optional: set the delay in milliseconds before it hides
        // });
