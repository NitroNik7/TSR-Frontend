...
var migUi = (function () {  // my Ui Head
    ...
    function getUserHead() {
        ...
        // -----------
        // var userProf = { status: 'signedIn', sal: 'Dear', fName: 'TSR Demo1', refCode: 'ROH_PUN', expDt: '05_Mar_2026', sub: 'TRADER_PRO' }; 
    ...
    function getSignedIn(tsrLogin) {
        ...
        if (tsrLogin) {
            ...
            html += '						      <li>'
            html += '						         <a data-bs-toggle="modal" data-bs-target="#viewProfileModal">'
            html += '						            <i class="far fa-handshake"></i>'
            html += '						            <span>View Profile</span>'
            html += '						         </a>'
            html += '						      </li>'
            ...
            viewProfileModalBody.innerHTML = `
                <p style="whitespace: nowrap; margin-bottom: 0px;">
                    To view your profile, we recommend you to <span style="color: red; font-weight: 500;"> login / register  </span> with TSR 
                </p>
    ...
    function getLogOff(tsrLogin, brokerLogin) {
        ...
        if (tsrLogin && brokerLogin) {
            html += '						      <li role="separator" class="divider"></li>'
            html += '						      <li> <a  data-bs-toggle="modal" data-bs-target="#logoutModal">'
    ...
    function getBrokers(brokerLogin) {
        ...
        if (brokerLogin) { // * user is connected with broker
            html += `<li onclick=""> `;
            html += `   <a href="">`
            html += `       <i class="fas fa-users"></i> Manage Brokers`;
            html += `   </a>`
            html += `</li> `;
        }
    ...
    */
    ...
    function userRegistrationModal() {
        ...
        let url = "https://www.topstockresearch.com/my/user/QuickRegis";
