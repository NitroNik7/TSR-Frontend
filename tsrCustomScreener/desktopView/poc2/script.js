...
// let popoverEleId = 'bullishCandleEle';

// let popoverEle = document.getElementById(popoverEleId);

// popoverEle.addEventListener('mouseenter', function () {
//     let popover = new bootstrap.Popover(popoverEle, { trigger: "focus" });
//     popover.show();
...
// var exampleTriggerEl = document.getElementById('bullishCandleEle')
